...
const platforms: SocialPlatform[] = [
    ...
    renderIcon: () => (
      <div className="flex items-center gap-2">
        ...
        <svg viewBox="0 0 24 24" width="32" height="32" fill="none">
          ...
          />
          <defs>
            <linearGradient id="twitterGrad" x1="3" y1="3" x2="23" y2="24">
        ...
        <svg viewBox="0 0 24 24" width="26" height="26" fill="none">
          ...
          />
          <defs>
            <linearGradient id="xGrad" x1="1.25" y1="2.25" x2="21.55" y2="21.75">
              <stop offset="0%" stopColor="#E5E4E2"/>
  ...
  },
  {
    ...
    renderIcon: () => (
      <svg viewBox="0 0 24 24" width="32" height="32" fill="none">
        <defs>
          <linearGradient id="igGrad" x1="2" y1="2" x2="22" y2="22">
            <stop offset="0%" stopColor="#E5E4E2"/>
  ...
  },
  {
    ...
    renderIcon: () => (
      <svg viewBox="0 0 24 24" width="32" height="32" fill="none">
        <defs>
          <linearGradient id="fbGrad" x1="0" y1="0" x2="24" y2="24">
            <stop offset="0%" stopColor="#E5E4E2"/>
            <stop offset="50%" stopColor="#E1E1E1"/>
  ...
  },
  {
    ...
    renderIcon: () => (
      <svg viewBox="0 0 24 24" width="32" height="32" fill="none">
        <defs>
          <linearGradient id="liGrad" x1="0" y1="0" x2="24" y2="24">
            <stop offset="0%" stopColor="#E5E4E2"/>
  ...
  },
  {
    ...
    renderIcon: () => (
      <svg viewBox="0 0 24 24" width="32" height="32" fill="none">
        <defs>
          <linearGradient id="ttGrad" x1="12" y1="2" x2="12" y2="22">
            <stop offset="0%" stopColor="#E5E4E2"/>
            <stop offset="50%" stopColor="#F5F5F5"/>
            <stop offset="100%" stopColor="#D4AF37"/>
          </linearGradient>
        ...
        <path
          d="M19.59 6H12a5.5 5.5 0 010-1V2h4.59l.41 2C17.73 6 19.59 6 19.59 6z"
          fill="url(#ttGrad)"
          opacity="0.5"
        />
        <path
          d="M16.5 9H15a3 3 0 01-6 0V4"
          stroke="url(#ttGrad)"
          strokeWidth="2.5"
          strokeLinecap="round"
          filter="url(#ttGlow)"
        />
        <path
          d="M7.5 11.5C7.5 15 10.33 18 13.8 18c2.98 0 5.7-1.8 7.2-4.2"
          stroke="url(#ttGrad)"
          strokeWidth="2.5"
          strokeLinecap="round"
          filter="url(#ttGlow)"
  ...
  },
  {
    ...
    renderIcon: () => (
      <svg viewBox="0 0 24 24" width="36" height="26" fill="none">
        <defs>
          <linearGradient id="ytGrad" x1="0" y1="0" x2="24" y2="24">
            <stop offset="0%" stopColor="#E5E4E2"/>
            <stop offset="30%" stopColor="#F5F5F5"/>
...
const danceVariants: Record<string, { hover: Record<string, number>; idle: Record<string, any> }> = {
  x: {
    idle: { rotate: [0, 8, -3, 5, 0], scale: [1, 1.05, 0.97, 1.03, 1] },
    hover: { rotate: [0, -15, 10, -5, 15, 0], scale: [1, 1.2, 0.9, 1.15, 1] },
  },
  ig: {
    idle: { rotateY: [0, 180, 360], scale: [1, 1.02, 1] },
    hover: { rotate: [0, 20, -20, 20, 0], scale: [1, 1.25, 0.95, 1.2, 1] },
  },
  fb: {
    idle: { x: [0, 6, 0, -6, 0], scale: [1, 1.03, 0.98, 1.04, 1] },
    hover: { rotate: [0, 25, -25, 25, 0], y: [0, -8, 0, -4, 0] },
  },
  li: {
    idle: { y: [0, -5, 0, -3, 0], scale: [1, 1.04, 0.96, 1.03, 1] },
    hover: { scale: [1, 1.3, 0.9, 1.2, 1], rotate: [0, 10, -10, 0] },
  },
  tt: {
    idle: { rotate: [0, 12, -8, 4, 0], scale: [1, 1.06, 0.95, 1.02, 1] },
    hover: { rotate: [0, 360], scale: [1, 1.2, 1] },
  },
  yt: {
    idle: { scaleX: [1, 1.04, 1], scaleY: [1, 1.02, 1] },
    hover: { scale: [1, 1.25, 1.05, 1.2, 1], y: [0, -6, 0] },
  },
};
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
          {platforms.map((platform, index) => {
            const variant = danceVariants[platform.danceVariant];
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    filter: "blur(15px)",
                    animation: `pulse-ambient ${3 + index * 0.5}s ease-in-out infinite`,
                  }}
                />
